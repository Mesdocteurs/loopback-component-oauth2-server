...
const authorizationCodeDef = require('../../common/models/oauth-authorization-code.json');
const clientApplicationDef = require('../../common/models/oauth-client-application.json');
const permissionDef = require('../../common/models/oauth-permission.json');
const scopeDef = require('../../common/models/oauth-scope.json');

const scopeMappingDef = require('../../common/models/oauth-scope-mapping.json');
